      ...
      <div className="relative flex size-full min-h-screen flex-col bg-[#111418] justify-between overflow-x-hidden" style={{ fontFamily: '"Space Grotesk", "Noto Sans", sans-serif' }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-8">
          ...
          <div className="max-w-4xl w-full text-center">
            <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">Get Started</h1>
            <p className="text-white text-base sm:text-lg md:text-xl font-normal leading-normal mb-8">
              We are here to offer you the best solutions, and the best of options have well being put in place for you.
            </p>
          </div>
          ...
          <div className="max-w-4xl w-full">
            <div className="grid grid-cols-[40px_1fr] gap-x-4">
              ...
              <div className="flex flex-1 flex-col pt-3 pb-5">
                <p className="text-white text-lg sm:text-xl font-medium leading-normal">Smart Contracts</p>
              ...
              <div className="flex flex-1 flex-col pt-3 pb-5">
                <p className="text-white text-lg sm:text-xl font-medium leading-normal">Services</p>
                <p className="text-white text-sm sm:text-base font-normal leading-normal mt-2">
              ...
              <div className="flex flex-1 flex-col pt-3 pb-5">
                <p className="text-white text-lg sm:text-xl font-medium leading-normal">Solutions</p>
                <p className="text-white text-sm sm:text-base font-normal leading-normal mt-2">
              ...
              <div className="flex flex-1 flex-col pt-3 pb-5">
                <p className="text-white text-lg sm:text-xl font-medium leading-normal">Roadmap</p>
                <p className="text-white text-sm sm:text-base font-normal leading-normal mt-2">
                  Built with AI-driven security to protect your intellectual property from fraud and theft.
                </p>
              </div>
